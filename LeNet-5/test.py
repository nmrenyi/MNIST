...
net = Net()
net.load_state_dict(torch.load('MNIST_net_LeNet-5-MAXPOOL.pth'))
# net.load_state_dict(torch.load(r'MNIST_net-AVGPOOL.pth'))
...
with torch.no_grad():
    for i in range(len(test)):
        ...
        result = ('Yes!' if (predicted == label).item() else 'No!')
